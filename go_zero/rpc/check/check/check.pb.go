...
var file_check_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x67, 0x32, 0x30, 0x0a, 0x05, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x27, 0x0a, 0x04,
	0x50, 0x69, 0x6e, 0x67, 0x12, 0x0e, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x52, 0x65, 0x73,
...
var file_check_proto_depIdxs = []int32{
	0, // 0: check.Check.Ping:input_type -> check.Request
	1, // 1: check.Check.Ping:output_type -> check.Response
...
func (c *checkClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/check.Check/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
